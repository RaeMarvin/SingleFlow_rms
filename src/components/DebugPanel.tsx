...
export function DebugPanel() {
  ...
  useEffect(() => {
    const getUserId = () => {
      let userId = localStorage.getItem('singleflow-user-id');
      if (!userId) {
        userId = crypto.randomUUID();
        localStorage.setItem('singleflow-user-id', userId);
      }
      return userId;
    };
        ...
        <button
          onClick={async () => {
            try {
              ...
              // Create a test task
              const userId = localStorage.getItem('singleflow-user-id') || crypto.randomUUID();
              localStorage.setItem('singleflow-user-id', userId);
